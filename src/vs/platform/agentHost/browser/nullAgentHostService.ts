...
import type { IAgentCreateSessionConfig, IAgentHostInspectInfo, IAgentHostService, IAgentHostSocketInfo, IAgentListSessionsOptions, IAgentResolveSessionConfigParams, IAgentSessionConfigCompletionsParams, IAgentSessionMetadata, AuthenticateParams, AuthenticateResult } from '../common/agentService.js';
...
export class NullAgentHostService implements IAgentHostService {
	...
	async listSessions(_options?: IAgentListSessionsOptions): Promise<IAgentSessionMetadata[]> { return []; }
