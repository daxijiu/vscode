...
import { ConfirmationOptionKind, TerminalClaimKind, ToolResultContentType, type ConfirmationOption, type ProtectedResourceMetadata, type SessionActiveClient, type ToolDefinition } from '../../../../../../platform/agentHost/common/state/protocol/state.js';
...
export class AgentHostSessionHandler extends Disposable implements IChatSessionContentProvider {
	...
	private _getCurrentActiveClient(customizations: ClientPluginCustomization[] = [...this._activeClientService.getCustomizations(this._config.sessionType).get()]): SessionActiveClient {
		return {
